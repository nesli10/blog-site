  ...
  return (
    <div>
      ...
      <div className="detayYazı">
        <p className="detayBaslık">What is Lorem Ipsum?</p> Lorem Ipsum is simply dummy text of the printing
        ...
        humour and the like).Where can I get some? There are many variations of
